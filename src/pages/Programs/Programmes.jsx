...
const Programmes = () => {
  return (
    <div className='bg-gray-200 py-8 xl:px-8 px-4'>
    ...
    {programData.map((program, index) => (
        <div className="xl:flex my-2 py-8" key={index}>
            ...
            <div className="w-full xl:ml-4 mt-4 xl:mt-0">
                <div className="grid grid-cols-1 xl:grid-cols-5 xl:grid-cols-4 gap-4">
