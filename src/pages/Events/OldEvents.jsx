            ...
            <div className="md:grid grid-cols-4 gap-4 py-8">
                {
                    testeventdata.map((event, index) => {
                        return (
                            <div data-aos="zoom-in" className="relative overflow-hidden bg-white md:my-0 my-4 py-4 rounded-md shadow-xl text-center px-4 duration-500 hover:border-b-4 hover:border-[#e8b910]" key={index}>
