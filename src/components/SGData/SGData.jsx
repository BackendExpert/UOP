...
const JanNewYear = () => {
  ...
  return (
    <div className='md:px-28 px-4 relative bg-[url(https://wallpapercave.com/wp/wp11704432.jpg)] bg-cover bg-center py-32 text-center text-white'>
...
const Aprilfunction = () => {
        const currentYear = new Date().getFullYear();
    return (
    <div className='md:px-28 px-4 relative bg-[url(https://t4.ftcdn.net/jpg/07/19/98/07/240_F_719980764_TTbvQ423nXXYgN8mcPxP6XXLDVIHUg4T.jpg)] bg-cover bg-center py-32 text-center text-white'>
        <div className="absolute inset-0 bg-black opacity-80"></div> 
        <div className="relative">
...
const WasakFunction = () => {
        const currentYear = new Date().getFullYear();
    return (
    <div className='relative bg-[url(https://wallpapercave.com/wp/wp14822684.webp)] bg-cover bg-center py-32 text-center text-white'>
        <div className="absolute inset-0 bg-black opacity-80"></div> 
        <div className="relative">
...
const AssalaPerahera = () => {
    const currentYear = new Date().getFullYear();
    return (
    <div className='relative bg-[url(https://kandyesalaperahera.com/wp-content/themes/kep2024/assets/images/Main_slider/h2.jpg)] bg-cover bg-center py-32 text-center text-white'>
        <div className="absolute inset-0 bg-black opacity-80"></div> 
        <div className="relative">
...
const MarryCrismistmas = () => {
    const currentYear = new Date().getFullYear();
    return (
    <div className='relative bg-[url(https://wallpapercave.com/wp/wp14781562.jpg)] bg-cover bg-center py-32 text-center text-white'>
        <div className="absolute inset-0 bg-black opacity-80"></div> 
        <div className="relative">
...
const DefultSG = () => {
    ...
    return (
    <div className='relative bg-[url(https://wallpapercave.com/wp/wp12885071.jpg)] bg-cover bg-center py-32 text-center text-white'>
